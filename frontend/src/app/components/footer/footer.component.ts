      ...
      <div class="footer-main">
        ...
        <div>
          <div class="brand-logo-row">
            <div class="brand-wordmark"><span class="trend">SHOP</span><span class="zy">ZEE</span></div>
          </div>
        ...
        <div>
          ...
          <ul class="col-links">
            ...
            <li>
              <a href="mailto:support@shopzee.me" style="display:flex;align-items:center;gap:0.5rem;">
